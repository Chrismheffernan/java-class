...
public class RomanNumeral {
	...
	private String testNumeral;
	int numOrder;
	
	public RomanNumeral(String romanNumeral, int numOrder)
	{
		this.numOrder = numOrder;
		this.romanNumeral = romanNumeral;
		this.testNumeral = romanNumeral;
		convertRoman(romanNumeral);
		convertArabic(numeralValue);
		invalidCheck();
	}
	
	public RomanNumeral(int numeralValue, int numOrder)
	{
		this.numOrder = numOrder;
		romanNumeral = "";
	...
	{
		if( !testNumeral.equals(romanNumeral))
		{
			invalid = true;
		}
